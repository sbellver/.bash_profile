...
# MacPorts Installer addition on 2014-10-20_at_15:24:12: adding an appropriate PATH variable for use with MacPorts.
export PATH="/opt/local/bin:/opt/local/sbin:$PATH"
# Finished adapting your PATH environment variable for use with MacPorts.

# 10. Personalización para eneboo y GIT

alias designer='open -a /Applications/eneboo/bin/designer.app --args $1'
alias de='open -a /Applications/eneboo/bin/designer.app --args $1'
function eneboo-crea() {
	eneboo-assembler dbupdate
	eneboo-assembler build $1 src -vvv
}
function eneboo-parche() {
	eneboo-assembler dbupdate
	eneboo-assembler build $1 fullpatch
	eneboo-assembler save-fullpatch $1
}
function eneboo-iconos() {
	eneboo-uiimage theme ~/Documents/git/enebootools/themes-uiimage/master_plane.ui $1 overwrite
}
